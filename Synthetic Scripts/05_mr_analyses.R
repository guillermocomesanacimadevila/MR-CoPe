...
if (length(args) != 1) {
  stop("Usage: Rscript 05_mr_analyses.R <filtered_SNPs_for_MR.csv>")
}
input_file <- args[1]
...
# --- Save harmonised data for visualization --- #
...
print("✅ MR analysis completed. Outputs: harmonised_data.csv, MR_Formatted_Results.csv, MR_IVW_OR_Per_SNP.csv")